...
The transformation also updates the Resolute goal with new evidential statements indicating that the model has indeed been hardened against the vulnerability and the requirement has been satisfied.
