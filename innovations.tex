...
microkernel \cite{seL4} that have used in both HACMS and CASE is formally verified,
from its high-level security properties down to its binary implementation.  
