...
The commercial board used for development and the Collins hardware equivalent (both ARM Cortex-A53 CPUs)
in the helicopter demonstration system used the same seL4 code base as the \figref{fig:sw-hardened} example.  
