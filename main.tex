...
\newcommand{\remove}[1]{{\color{blue}#1}}
\renewcommand{\remove}[1]{}
\newcommand{\replace}[2]{\remove{#1}{\color{green}#2}}
...
\author{Gerwin Klein}
\affil{Proofcraft and University of New South Wales, Sydney}

\author{Corey Lewis}
\affil{University of New South Wales, Sydney}
